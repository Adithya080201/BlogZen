...
import org.udemy.SpringBlog.services.AuthorityService;
...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        account2.setAge(22);
        account2.setDateOfBirth(LocalDate.parse("1999-03-30"));
        ...
        account3.setAge(32);
        account3.setDateOfBirth(LocalDate.parse("2008-02-16"));

        account4.setEmail("supereditor@editor.com");
        account4.setPassword("pass123");
        account4.setFirstName("editor");
        account4.setLastName("lastname");
        account4.setRole(Roles.EDITOR.getRole());
        account4.setGender("others");
        account4.setAge(33);
        account4.setDateOfBirth(LocalDate.parse("1996-02-16"));
